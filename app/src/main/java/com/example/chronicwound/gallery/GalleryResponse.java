...
public class GalleryResponse {
    ...
    public GalleryResponse(String _id, String id_pasien, String id_perawat, String filename, String filepath, String category, String created_at, String updated_at) {
        this._id = _id;
        this.id_pasien = id_pasien;
        this.id_perawat = id_perawat;
        this.filename = filename;
